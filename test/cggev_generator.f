...
*     cggev, and outputting the inputs and the results.

      program cggev_generator
      ...
      complex*8 a(n, n), b(n, n), alpha(n), beta(n), l(n, n), r(n, n)
      real*4 work(1024), rwork(8*n)
      real*4 v(2)
 ...
 35   continue
      ...
      call cggev('V', 'V', n, a, n, b, n, alpha, beta, l, n, r, n, work,
     $     1024,rwork, info)
