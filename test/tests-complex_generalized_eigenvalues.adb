...
package body Tests.Complex_Generalized_Eigenvalues is
   ...
   package body Tests_G is
      ...
      begin
         return new String'(Type_Name & ": Complex_Generalized_Eigenvalues");
      end Name;
      ...
      Input_A : constant Complex_Matrix (3 .. 8, 13 .. 18) :=
      ...
      Input_B : constant Complex_Matrix (Input_A'Range (1),
                                         Input_A'Range (2)) :=
      ...
      Expected_Betas : constant Complex_Vector (Input_A'Range (1)) :=
      ...
      Expected_Eigenvectors : constant Complex_Matrix (Input_A'Range (1),
                                                       Input_B'Range (2)) :=
